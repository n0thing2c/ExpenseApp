...
namespace Login.Page
{
    public partial class MenuForm : Form
    {
        ...
        private void uc_OpenFileClicked(string filepath)
        {
            ...
            ucLoadFile ucLF = new ucLoadFile();
